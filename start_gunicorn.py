...
def main():
    parser = argparse.ArgumentParser(description="使用 Gunicorn 启动 vLLM Rerank 服务")
    ...
    parser.add_argument("--config", default="gunicorn_vllm_config.py", help="Gunicorn配置文件路径")
    ...
    print("=" * 60)
    print("vLLM Rerank 服务 - Gunicorn 启动器")
    print("=" * 60)
